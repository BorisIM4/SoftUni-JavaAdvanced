...
public class Main {
    public static void main(String[] args) {
        ...
        Threeuple<String, String, String  > personInDetails = new Threeuple<>(name, address, city);
        ...
        Threeuple<String, Double, String> numbrrs = new Threeuple<>(name, amount, bankName);
