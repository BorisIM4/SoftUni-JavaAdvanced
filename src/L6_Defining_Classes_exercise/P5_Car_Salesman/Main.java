package L6_Defining_Classes_exercise.P5_Car_Salesman;
        ...
        while (lines-- > 0) {
            ...
            switch (engineData.length) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    new Engine(model, power, Integer.parseInt(engineData[2]), engineData[3]);
                    break;
            }
        }
            ...
            if (engine != null) {
                ...
                switch (carData.length) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        new Car(model, engine, Integer.parseInt(carData[2]), carData[3]);
                        break;
                }
            }
        }
